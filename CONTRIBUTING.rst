...
Welcome to ``algae`` contributor's guide.
...
If you experience bugs or general issues with ``algae``, please have a look
...
You can help improve ``algae`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``algae`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``algae``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n algae python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/algae.git
    cd algae
...
#. Install |pre-commit|_::
   ...
   ``algae`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/algae
.. _issue tracker: https://github.com/<USERNAME>/algae/issues
.. <-- end -->
